...
export const samplePlnPackage: ImportPackage = {
  ...
  locations: [
    { id: 'loc-01', warehouseCode: 'GUD-PLN-MLG-AM01', zone: 'Zona B (Heavy Material & Trafo)', rack: 'Jalur 2', bin: 'Blok H-04' },
    { id: 'loc-02', warehouseCode: 'GUD-PLN-MLG-AM01', zone: 'Zona A (Rak Perlengkapan Gardu)', rack: 'Rak A3', bin: 'Tingkat 2' },
    { id: 'loc-03', warehouseCode: 'GUD-PLN-MLG-AM01', zone: 'Zona C (Ruang Bersih Kalibrasi APP)', rack: 'Lemari Meter 1', bin: 'Kotak 12' },
    { id: 'loc-04', warehouseCode: 'GUD-PLN-MLG-AM01', zone: 'Zona D (Gudang APD & Tool K3)', rack: 'Rak K3-01', bin: 'Rak 1' },
    { id: 'loc-05', warehouseCode: 'GUD-PLN-MLG-AM01', zone: 'Zona B (Heavy Material & Kabel)', rack: 'Jalur 1', bin: 'Blok Drum D-02' },
  ],
  materials: [
    {
      id: 'mat-001',
    ...
    },
    {
      ...
      code: '000789',
      sapCode: '100045129',
      name: 'Smart Meter Listrik AMI 1 Fasa 5(60)A',
      categoryId: 'cat-kwh',
      unit: 'Buah',
